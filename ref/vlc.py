...
def background_process():
    ...
    while cap.isOpened():
        ...
        target_frame = frame[top:bottom, left:right]
        ...
        if result_cnt == decision_threshold:
            ...
            result_cnt = 0
        #-----------------DISPLAY CAMERA------------------#
        frame = cv2.putText(frame,result,(100,100),cv2.FONT_HERSHEY_SIMPLEX,1,(255,0,0),5)
        cv2.imshow("cam",frame)
        cv2.waitKey(1)

#-----------------------------------------PROGRAM START-----------------------------------------#
model = keras.models.load_model('C:/Users/Sohan/GitHub/Gesture Control/ref/models/all_model1.h5')
